        ...
        <>
          ...
          >
            ...
            <div className="bottom-sheet-content">
              ...
              <button type="button" className="bottom-sheet-item" onClick={closeSheet}>
                <div className="bottom-sheet-icon">
                  <MinusIcon />
                </div>
                <div className="bottom-sheet-text">
            ...
            {borrowedAmount > 0 && (
              <section className="confirm-screen-borrowing">
                ...
                <div className="confirm-row confirm-row--stacked">
                  ...
                  <div className="confirm-row-multi">
                    <span className="confirm-row-value confirm-row-value--highlight">
                      {formatPrice(interestMonthly)} / month
                    </span>
                    <span className="confirm-row-sub">
